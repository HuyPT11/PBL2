...
void Bill::Show()
{
    ...
    fo << "Ma hoa don: " << this->IDB << '\n';
    fo << "Ngay Thang Nam thanh toan: " << this->Day << "/" << this->Month << "/" << this->Year << '\n';
    fo << "Ma khach hang: " << this->IDC << '\n';
    fo << "Ten khach hang: " << this->NameCustomer << '\n';
    fo << "Tong tien: " << this->SumPrice << '\n';
    //fo.close();
}